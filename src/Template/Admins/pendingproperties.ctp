                            ...
                            <div class="row">
                               ...
                               <?php $count =0; foreach ($property->images as $image): $count++; ?>
                                    <div class="property-image" style="background: url('property_images/'<?= $image->imageurl?>) center center / cover no-repeat;">
                                        <?=$this->html->image('/property_images/'.$image->imageurl,['class'=>'property-image','height'=>'41','width'=>'330'])?>     
                              ...
                              <?= $this->Html->link($property->listing_title, ['controller' => 'Admins', 'action' => 'preview',$property->id,$this->GenerateUrl($property->listing_title)],
                                      ['class'=>'col-blue-grey','title'=>'preview this property']) ?> |
                               <?= $this->Html->link(' Update Property', ['controller' => 'Admins', 'action' => 'Update',$property->id,$this->GenerateUrl($property->listing_title)],['title'=>'update property details']) ?> 
                                        ...
                                        <div class="property-action m-t-15">
                                           ...
                                           <a href="#" title="Availability"><i class="zmdi zmdi-settings"></i><span>Availability : <?=$property->listing_market_status?>
                                            ...
                                            <a href="#" title="Date Uploaded"><i class="zmdi zmdi-calendar-check"></i><span>Uploaded on : <?= h(date("d-M-Y : h:i",strtotime($property->listing_date_added))) ?>
                                                </span></a>
                                            ...
                                            }else{echo '<span class="badg bg-green">Approved</span>';}
                                            ?> 
