        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-xs-12">
                <div class="card property">
                    ...
                    <?php if(!empty(array_filter($myproperties->toArray()))){ ?>
					<div class="body">
                 ...
                 echo ' | '.$this->Html->link(__('Delete Images'), ['action' => 'viewimages',$property->id,$this->GenerateUrl($property->listing_title)],
                ...
                ?>
                                        ...
                                        <div class="property-action m-t-15">
                                         ...
                                         <?= $this->Html->link(__('+ More Images'), ['action' => 'addimage',$property->id,$this->GenerateUrl($property->listing_title)],
