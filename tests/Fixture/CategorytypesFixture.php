...
class CategorytypesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'categorytypename' => ['type' => 'string', 'length' => 64, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'categorytypes_ibfk_1' => ['type' => 'foreign', 'columns' => ['category_id'], 'references' => ['categories', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'id' => 1,
            'category_id' => 1,
            'categorytypename' => 'Lorem ipsum dolor sit amet',
            'status' => 1
        ],
    ];
}
